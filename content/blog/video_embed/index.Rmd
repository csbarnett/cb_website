...
However, as is often the case with R, there is more than one solution. Using the *vembedr package* is another way to embed videos in your Markdown documents that get around our Pandoc issues to easily embed videos in code chunks using their URL or a file path on your machine. The *vembedr package* includes an **enbed_url() function** that accepts a URL or file path as an argument.
